<template>
	<main>
		...
		<p class="btn-group">
			...
			<kx-task-button class="info outline" :on-click="ck">
				加载按钮
				<template v-slot:running>正在加载</template>
			</kx-task-button>
			<kx-task-button class="dangerous" :on-click="ck">
				加载按钮
				<template v-slot:running>正在加载</template>
			</kx-task-button>
		</p>
