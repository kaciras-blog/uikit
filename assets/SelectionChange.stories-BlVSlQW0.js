import{r as i}from"./vue.esm-bundler-Bzz_P2ly.js";import{a as v}from"./common-CifugGsY.js";const c=Symbol("SelectionListener");function r(e,n){const{value:t}=n,a=typeof t=="function"?t:(o,l)=>t.splice(0,2,o,l);e[c]=v(e,a)}const d={updated(e,n){e[c](),r(e,n)},mounted:r,unmounted:e=>e[c]()},p={},s=()=>({directives:{selectionChange:d},template:`
        <textarea
