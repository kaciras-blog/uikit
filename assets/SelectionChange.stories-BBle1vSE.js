import{r as i}from"./vue.esm-bundler-CTBZv7kY.js";import{a as v}from"./common-DLq63pbG.js";const c=Symbol("SelectionListener");function r(e,n){const{value:t}=n,a=typeof t=="function"?t:(o,l)=>t.splice(0,2,o,l);e[c]=v(e,a)}const d={updated(e,n){e[c](),r(e,n)},mounted:r,unmounted:e=>e[c]()},p={},s=()=>({directives:{selectionChange:d},template:`
        <textarea
